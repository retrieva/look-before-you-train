# step26b_v25_clean87.py - step26のsplit選択肢にclean87を追加しただけの版
# 元: step26_v25.py - CORE v2.5: DNF (AND句のOR) メンバーシップエンジン
...
def main():
    ...
    ap.add_argument("--split", default="train60", choices=["train60", "test100", "clean87"])
